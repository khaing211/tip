 ...
 *
 * Input Format First line contains T that denotes the number of test cases. This is followed by T
 * lines, each containing an integer, N.
 *
 * Output Format For each test case, print an integer that denotes the sum of all the multiples of 3
 * or 5 below N.
 *
