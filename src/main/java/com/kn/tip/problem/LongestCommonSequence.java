...
/**
 * Find the longest common sequence of 2 arrays
 */
public interface LongestCommonSequence {
  ...
  public static int[] compute(int[] a, int[] b) {
     ...
     * System.out.println();
     * 
     * for (int x = 0; x < a.length; x++) { System.out.println(Arrays.toString(trace[x])); }
     * 
     * System.out.println();
     * 
     * for (int x = 0; x < a.length; x++) { System.out.println(Arrays.toString(len[x])); }
     * 
     * System.out.println(); System.out.println(Arrays.toString(result));
     */
