...
public class LinkCutTree {
  ...
  public static class Node {
    ...
    void update() {
      subTreeValue = queryOperation(
          queryOperation(getSubTreeValue(left), joinValueWithDelta(nodeValue, delta)),
  ...
  static int getSubTreeValue(Node root) {
    return root == null ? getNeutralValue()
  ...
  // makes node x the root of the virtual tree, and also x becomes the leftmost node in its splay
  // tree
