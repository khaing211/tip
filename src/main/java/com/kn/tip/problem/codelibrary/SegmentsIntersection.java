...
public class SegmentsIntersection {
  ...
  public static boolean isCrossIntersect(long x1, long y1, long x2, long y2, long x3, long y3,
      long x4, long y4) {
  ...
  public static boolean isCrossOrTouchIntersect(long x1, long y1, long x2, long y2, long x3,
  ...
  public static Point2D.Double getLinesIntersection(long x1, long y1, long x2, long y2, long x3,
      long y3, long x4, long y4) {
    long a1 = y2 - y1;
    long b1 = x1 - x2;
    long c1 = -(x1 * y2 - x2 * y1);
  ...
  public static void main(String[] args) {
    ...
    for (int step = 0; step < 1000_000; step++) {
      ...
      if (crossOrTouchIntersect != crossOrTouchIntersect2
          || crossIntersect && !crossOrTouchIntersect)
        throw new RuntimeException();
    }
    System.out
        .println(getLinesIntersection(0, 0, 4, 2, 2, -1, 2, 5).equals(new Point2D.Double(2, 1)));
  }
}
