...
public class Hashing {
  ...
  static final int mod1 =
      BigInteger.valueOf((int) (1e9 + rnd.nextInt((int) 1e9))).nextProbablePrime().intValue();
  static final int mod2 =
      BigInteger.valueOf((int) (1e9 + rnd.nextInt((int) 1e9))).nextProbablePrime().intValue();
  static final int invMultiplier1 =
      BigInteger.valueOf(multiplier).modInverse(BigInteger.valueOf(mod1)).intValue();
  static final int invMultiplier2 =
      BigInteger.valueOf(multiplier).modInverse(BigInteger.valueOf(mod2)).intValue();
  ...
  public static void main(String[] args) {
    ...
    for (int step = 0; step < 1000; step++) {
      ...
      for (int k = 0; k < 1000; k++) {
        ...
        if (s1.substring(i1, j1)
            .equals(s2.substring(i2, j2)) != (h1.getHash(i1, j1 - i1) == h2.getHash(i2, j2 - i2)))
