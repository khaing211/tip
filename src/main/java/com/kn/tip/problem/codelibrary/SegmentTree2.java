...
public class SegmentTree2 {
  ...
  void pushDelta(int root, int left, int right) {
    ...
    value[(2 * root + 1)] = joinValueWithDelta(value[(2 * root + 1)],
        deltaEffectOnSegment(delta[root], mid - left + 1));
    value[(2 * root + 2)] =
        joinValueWithDelta(value[(2 * root + 2)], deltaEffectOnSegment(delta[root], right - mid));
