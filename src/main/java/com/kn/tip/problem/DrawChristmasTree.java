...
public class DrawChristmasTree {
  ...
  public static int drawTree(int maxLevel, int curleveL, double ratio, int baseLevelIndent,
    ...
    final int treeWidth =
        drawTree(maxLevel, curleveL - 1, ratio, baseLevelIndent + curleveL, random);
    drawBranch(maxLevel, curleveL, ratio, baseLevelIndent, treeWidth, random);

    return treeWidth;
  }

  public static void drawBranch(final int maxLevel, final int curLevel, final double ratio,
      final int baseLevelIndent, final int treeWidth, final Random random) {
