 ...
 *
 * Given the nth and (n+1)th terms, the (n+2)th can be computed by the following relation Tn+2 =
 * (Tn+1)2 + Tn
 *
 * So, if the first two terms of the series are 0 and 1: the third term = 12 + 0 = 1 fourth term =
 * 12 + 1 = 2 fifth term = 22 + 1 = 5 ... And so on.
 *
 ...
 * Output Format
 *
 * One integer. This integer is the Nth term of the given series when the first two terms are A and
 * B respectively.
 *
 * Note
 *
