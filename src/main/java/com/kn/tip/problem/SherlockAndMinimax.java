...
/**
 * Watson gives Sherlock an array A[1],A[2]...A[N]. He asks him to find an integer M between P and
 * Q(both inclusive), such that, min {|A[i]-M|, 1 ≤ i ≤ N} is maximised. If there are multiple
