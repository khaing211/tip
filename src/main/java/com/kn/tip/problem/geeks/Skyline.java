...
public class Skyline {
  ...
  /**
   * Assume buildings are sorted by left Assume no two buildings start at the same left?
   * 
   * Find the skyline
   * 
  ...
  public static void main(String[] args) {
    System.out.println(findSkyLine(
        new Building[] {Building.create(1, 11, 5), Building.create(2, 6, 7),
            Building.create(3, 13, 9), Building.create(12, 7, 16), Building.create(14, 3, 25),
            Building.create(19, 18, 22), Building.create(23, 13, 29), Building.create(24, 4, 28)},
        0, 7));
  }
