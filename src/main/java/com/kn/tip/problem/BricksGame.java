...
/**
 * You and your friend decide to play a game using a stack consisting of N bricks. In this game, you
 * can alternatively remove 1, 2 or 3 bricks from the top, and the numbers etched on the removed
 ...
 *
 * Input Format First line will contain an integer T i.e. number of test cases. There will be two
 * lines corresponding to each test case: first line will contain a number N i.e. number of elements
 * in the stack and next line will contain N numbers i.e. numbers etched on bricks from top to
 * bottom.
 *
 * Output Format For each test case, print a single line containing your maximum score.
 *
 * Constraints 1 ≤ T ≤ 5 1 ≤ N ≤ 10^5 0 ≤ each number on brick ≤ 10^9
 */
public interface BricksGame {
   ...
   *
   * indices[h] = next index after taking brick from h to h+i for h+i < indices[h] using optional
   * strategy
   *
