 ...
 * 
 * Almost like insertion sort with k comparison + the fact it is natural N integer you can make it
 * O(n) instead of O(n^2) just by keeping index of each element
 */
