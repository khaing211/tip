 ...
 * Traverse only right or down. Example: starting index is 15 (left top) and ending index is 10
 * (bottom right)
 * 
 * Solution: this is a longest path is acylic graph
 * 
 * Example Input: 15 25 30 45 25 60 70 75 10
 * 
 * Example output: 15->45->70->75->10 sum is 215
 */
