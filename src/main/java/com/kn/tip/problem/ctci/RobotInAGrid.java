...
/**
 * Imagine a robot sitting on the upper left corner of grid with r row, c col The robot can only
 * move, right or down, but certain cells are "off-limits" i.e. robot cannot step on them.
 * 
