...
public interface ArrayUtils {
  public static void printArray(int[] array) {
    System.out.println(
        Arrays.stream(array).mapToObj(i -> Integer.toString(i)).collect(Collectors.joining(" ")));
  }
  ...
  public static <T> int findIndex(T[] array, int startIndex, int endIndex, T value,
