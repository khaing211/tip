...
public class TreeDiameterTest {
  ...
  public void testLongestPathGoThroughTopTree() {
    final Tree<Integer> tree = Tree.root(0).left(1).right(2);
  ...
  public void testLongestPathGoThroughSubtree() {
    final Tree<Integer> tree = Tree.root(0).left(1).right(2).transverseLeft().left(3).right(4)
        .transverseRight().right(5).transverseRight().right(6).transverseParent().transverseParent()
        .transverseLeft().left(7).transverseLeft().left(8);
